  ...
  return (
    <Section className="pt-8 sm:pt-28">
      <div className="max-w-3xl mx-auto prose prose-navy">
        <h1 className="text-3xl sm:text-4xl font-bold font-heading text-navy-800 mb-2">Refund Policy</h1>
        <p className="text-gray-500 text-sm mb-8">Last updated: January 1, 2026</p>

        <div className="space-y-8 text-gray-700 leading-relaxed">
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">1. Cancellation Policy</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">2. Course Rescheduling</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">3. Course Cancellation by Pulse Medication</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">4. Refund Processing</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">5. How to Request a Refund</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">6. Exceptions</h2>
