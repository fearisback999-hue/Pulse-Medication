  ...
  return (
    <Section className="pt-8 sm:pt-28">
      <div className="max-w-3xl mx-auto prose prose-navy">
        <h1 className="text-3xl sm:text-4xl font-bold font-heading text-navy-800 mb-2">Terms &amp; Conditions</h1>
        <p className="text-gray-500 text-sm mb-8">Last updated: January 1, 2026</p>

        <div className="space-y-8 text-gray-700 leading-relaxed">
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">1. Agreement to Terms</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">2. Course Enrollment</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">3. Payment Terms</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">4. Attendance Requirements</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">5. Course Materials</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">6. Code of Conduct</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">7. Certification</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">8. Limitation of Liability</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">9. Changes to Terms</h2>
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-navy-800 mb-3">10. Contact</h2>
